...
<div align="center">
  ...
  <img src="https://img.shields.io/badge/Last%20Updated-March%2030%2C%202026-lightgrey" alt="Last Updated: March 30, 2026">
</div>
...
<div>
  ...
  <img src="https://img.shields.io/badge/Proxmox-%23E57000.svg?style=for-the-badge&logo=proxmox&logoColor=white" alt="Proxmox">
</div>

## 💼 Experience

### QA Automation Engineer Intern — SAP France (6 months)

During a 6-month internship at **SAP France**, I maintained and developed automated tests for parts of **SAP Analytics Cloud**.

- Maintained and expanded automated E2E test suites using an internal framework based on **Java + Selenium**
- Managed and maintained a **Selenium Grid**, and learned to master robust locator strategies
- Orchestrated executions with **Jenkins** using **Groovy** and **Bash**
- Reported and tracked results directly in **Jira**
- Set up monitoring with **Prometheus** and **Grafana** (both installed on a **SUSE Linux** server)
- Helped integrate performance testing and facilitate version deployments
...
On my free time, I'm currently working through **Rustlings** to learn Rust.
...
### [Decobolizator](https://github.com/Decobolizator)
**Explaining legacy COBOL code in natural language**

I’m currently working with my team on **Decobolizator**, a project aiming to make COBOL legacy systems easier to understand by translating and documenting code in clear natural language.

- **Technologies used**: PostgreSQL, Redis
- **Role**: Defined the technical architecture and guide developers as project lead
